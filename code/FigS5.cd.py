...
gamma_curve_labels = [
    r'$\gamma(\omega)$, $D=-1.159$',
    r'$\gamma(\omega)$, $D=-1.359$'
]

b_disk_label = r'eigenvalue disk $|b|\leq r_B$'

tilde_disk_labels = [
    r'eigenvalue disk $|\tilde{b}-D|\leq r_B$, $D=-1.159$',
    r'eigenvalue disk $|\tilde{b}-D|\leq r_B$, $D=-1.359$'
]
...
plt.savefig('combined_four_panels_1.svg', format='svg', bbox_inches='tight')
plt.show()
print(xlim, ylim)